...
export default function Privacy() {
  return (
    <section className="bg-white text-[#1e3a5f] py-16 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          At Clixonic Media, we value your privacy and are committed to protecting
        ...
        <p className="text-gray-600 mb-4 leading-relaxed">
          ...
          phone number, and website information when you contact us, fill out
          forms, or use our services.
        </p>
        ...
        <p className="text-gray-600 mb-4 leading-relaxed">
          ...
          improve our website, and provide marketing updates only with your
          consent.
        </p>
        ...
        <p className="text-gray-600 mb-4 leading-relaxed">
          ...
          and improve performance. You can manage cookie preferences anytime.
        </p>
        ...
        <p className="text-gray-600 mb-4 leading-relaxed">
          ...
          trusted partners for analytics, advertising, or service delivery —
        ...
        <p className="text-gray-600 mb-4 leading-relaxed">
          You have the right to request access, update, or delete your personal
