...
export default function Pricing() {
  ...
  return (
    <>
      <SEO
        title="Pricing | Digital Marketing & SEO Services – Clixonic Media"
        description="Explore flexible pricing plans for SEO, PPC, social media marketing, and web development. Custom plans available."
        image="https://clixonicmedia.com/pricing-og.jpg"
        schema={{
              ...
              {FAQS.map((item, i) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <h4 className="font-semibold text-[#1e3a5f]">{item.q}</h4>
                    <ChevronDown
